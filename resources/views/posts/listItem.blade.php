    ...
    <div class="post_meta">
      ...
      <div class="post_details">
        <a
          ...
          <a class="category_name" href="/category/{{ $post->category->slug }}">{{ $post->category->name }}</a><time class="post_date">{{ \Carbon\Carbon::parse($post->updated_at)->diffForHumans() }}</time>
        </div>
    </div>
  </header>
